                ...
                _buildIconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const HelpBedStartScreen()),
                    );
                  },
                ),
                ...
                _buildIconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const HelpBathStartScreen()),
                    );
                  },
                ),
                SizedBox(height: screenHeight * 0.01), // ボタン間の隙間
                ...
                _buildIconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const HelpTableStartScreen()),
                    );
                  },
                ),
              ],
          ...
          child: Stack(
            children: [
              ...
              Center(
                child: IconButton(
                  icon: Icon(icon,
                      size: screenWidth * 0.25), // アイコンのサイズを画面サイズに基づいて調整
                  onPressed: onPressed,
