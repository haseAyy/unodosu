...
//テーブル問題出題画面
class HelpTableScreen extends StatefulWidget {
  ...
  @override
  _HelpTableScreenState createState() =>
      _HelpTableScreenState(questionCount, correctCount);
}

class _HelpTableScreenState extends State<HelpTableScreen> {
  late Future<Question?> questionFuture;
  late int questionCount; //このクラス内で管理する変数
  late int correctCount; //正解数を追跡する変数

  //コンストラクタで初期値を設定
  _HelpTableScreenState(this.questionCount, this.correctCount);
